...
$products = [
    1 => ["name"=>"Boligrafos", "desc"=>" excelente calidad, ideal para estudiantes y uso diario.", "price"=>233.00],
    2 => ["name"=>"Correctores", "desc"=>" excelente  calidad.", "price"=>220.00, ],
    3 => ["name"=>"Portaminas", "desc"=>" calidad exelente.", "price"=>250.00, ],
    4 => ["name"=>"Cutters", "desc"=>"excelente calidad y cortes finos.", "price"=>160.00, ],
    5 => ["name"=>"Cinta adehsiva", "desc"=>"excelente pegamento.", "price"=>150.00, ],
    6 => ["name"=>"Engrapadoras", "desc"=>"exelente calidad.", "price"=>190.00, ]
];
...
<header class="site-header">
    ...
    <nav class="nav">
        <a href="oficinap3.php">C̳a̳t̳á̳l̳o̳g̳o̳</a> |
