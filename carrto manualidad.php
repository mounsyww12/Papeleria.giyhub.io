...
$products = [
    1 => ["name"=>"Papel crepe", "desc"=>" excelente calidad, ideal para estudiantes y uso diario.", "price"=>200.00],
    2 => ["name"=>"Brillantina", "desc"=>" excelente  calidad.", "price"=>210.00, ],
    3 => ["name"=>"Pegamento especial", "desc"=>" calidad exelente.", "price"=>280.00, ],
    4 => ["name"=>"Fieltro", "desc"=>"excelente calidad y cortes finos.", "price"=>60.00, ],
    5 => ["name"=>"Pintura acrilica", "desc"=>"excelente pegamento.", "price"=>110.00, ],
    6 => ["name"=>"Pinturas Oleo", "desc"=>"exelente calidad.", "price"=>90.00, ]
];
...
<body color="#0a96b9ff;" <p style="color: -#0e8cc2ff;"></p>
...
<header class="site-header">
    ...
    <nav class="nav">
        <a href="manualidadesp3.php">C̳a̳t̳á̳l̳o̳g̳o̳</a> |
...
<main class="container">
    ...
    <a href="manualidadesp3.php">Catálogo</a>
                </form>
            </div>
        <?php endif; ?>
    </section>
